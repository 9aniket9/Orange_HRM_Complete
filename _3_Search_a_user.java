...
public class _3_Search_a_user {
	...
	public static void main(String[] args) throws Throwable {
		...
		WebElement Search=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[normalize-space()='Search'])[1]")));
		Search.click();
		...
		WebElement Sys_emp_name=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@placeholder='Type for hints...']")));
		Sys_emp_name.click();
